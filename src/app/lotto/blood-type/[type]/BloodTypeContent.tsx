...
interface Props {
  ...
  totalRounds: number;
  bestPair: BloodPair | null;
  worstPair: BloodPair | null;
  prevType: { id: string; name: string };
  nextType: { id: string; name: string };
}
...
export default function BloodTypeContent({
  profile,
  numberStats,
  avoidStats,
  matchedRounds,
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 space-y-8">
      <header className="text-center space-y-3">
        <div className="inline-block px-3 py-1 rounded-full text-sm font-semibold text-white bg-red-600">
          한국인의 {profile.percentage}
        </div>
