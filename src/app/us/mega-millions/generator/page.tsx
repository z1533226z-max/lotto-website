...
export const metadata: Metadata = {
  ...
  description:
    'Generate random Mega Millions tickets respecting the 5/70 + 1/24 format. Pick 1 to 10 lines instantly. No signup, no clutter — just the numbers.',
    ...
    <article className="space-y-6">
      <header>
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-300">
          ...
          5 white balls from 1–70 plus 1 gold Mega Ball from 1–24.
        </p>
      </header>
      <LotteryGenerator game="mega-millions" mainMax={70} mainCount={5} bonusMax={24} bonusLabel="Mega Ball" />
